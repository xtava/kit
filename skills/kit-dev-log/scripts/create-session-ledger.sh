...
Complete the context tree and identify the development loop.

## Recovery

Read `index.md`, then `objective.md`, `context.md`, `dev-loop.md`, linked tasks, and linked ADRs.
EOF
...
Add an `Open questions` branch only when an unresolved fact can change the design.
EOF
